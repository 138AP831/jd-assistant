...
export function BrainIcon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      ...
      <path d="M9 2.5C6 3 4 5.5 4 8.5c0 1.5.5 2.9 1.3 4"/>
      <path d="M15 2.5c3 .5 5 3 5 6 0 1.5-.5 2.9-1.3 4"/>
      <path d="M12 12c-2 0-4 1-5 3"/>
      <path d="M12 12c2 0 4 1 5 3"/>
      <path d="M7 15.5C7 18 9 20 12 20s5-2 5-4.5"/>
...
export function SourceIcon({ size = 13, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
